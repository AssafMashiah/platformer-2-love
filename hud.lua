...
function HUD:drawInventorySlots()
    ...
    for i = 1, maxSlots do
        ...
        if inventory[i] then
            ...
            love.graphics.setFont(self:getFont(7))
...
function HUD:drawMenu()
    ...
    if self.showControls then
        ...
        love.graphics.setFont(self:getFont(36))
        ...
        for i, option in ipairs(self.menuOptions) do
            ...
            if i == self.menuSelection then
                ...
                love.graphics.setFont(self:getFont(20))
                love.graphics.printf("> " .. option .. " <", centerX - 200, y, 400, "center")
            else
                love.graphics.setColor(0.6, 0.6, 0.6)
                love.graphics.setFont(self:getFont(18))
                love.graphics.printf(option, centerX - 200, y, 400, "center")
            end
        end
...
function HUD:drawControlsScreen(centerX, centerY)
    love.graphics.setColor(0.5, 0.8, 1)
    love.graphics.setFont(self:getFont(28))
...
function HUD:drawGameOver()
    ...
    love.graphics.setFont(self:getFont(48))
