...
function Platform:generateTileGraphics()
    ...
    local canvas = love.graphics.newCanvas(tileW * 3, tileH * 3)
...
function Platform:draw()
    ...
    for row = 0, tilesY - 1 do
        for col = 0, tilesX - 1 do
            ...
            local srcX = (col % 3) * tileW
            local srcY = (row % 3) * tileH
            love.graphics.draw(self.image, destX, destY, 0, 1, 1, srcX, srcY)
        end
    end
end
